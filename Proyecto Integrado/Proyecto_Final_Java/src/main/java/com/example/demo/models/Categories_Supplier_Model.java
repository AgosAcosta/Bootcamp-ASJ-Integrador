...
public class Categories_Supplier_Model {

	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	@Column(unique = true, nullable = false)
	private Integer id_category_supplier ;
	...
	public Categories_Supplier_Model() {
	}

	public Categories_Supplier_Model(Integer id_category_supplier,
	...
	public Integer getId_category_supplier() {
		return id_category_supplier;
	}
	public void setId_category_supplier(Integer id_category_supplier) {
		this.id_category_supplier = id_category_supplier;
	}
